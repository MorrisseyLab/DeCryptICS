"""
    ...
    taken from https://raw.githubusercontent.com/Visual-Behavior/detr-tensorflow/main/detr_tf/bbox.py    
"""
...
def single_xcycwh_to_xy_min_xy_max(bbox: tf.Tensor) -> tf.Tensor:
    """
    Convert bbox from shape [xc, yc, w, h] to [xmin, ymin, xmax, ymax]
    Args:
        bbox A (tf.Tensor) a single bbox (1, 4)
    Returns:
        The converted bbox
    """
    # convert the bbox from [xc, yc, w, h] to [xmin, ymin, xmax, ymax].
