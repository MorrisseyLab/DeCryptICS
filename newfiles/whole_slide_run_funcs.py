...
weights_name = os.path.join(dnnfolder, 'weights', 'pixshuf_cryptclass_11mpp.hdf5')
...
#   output_folder = '/home/doran/Work/images/test/Analysed_slides/Analysed_586572/'
#   crypt_thresh=0.8
#   seg_max_len=20
#   seg_batch_size=16
#   min_micrn_overlap=80
#   bbox_batch_size=25
#   max_bboxes=400
#   repeat_method='largest'
#   save_contours=True
...
#   wh_gen.get_img_thmb_tilerect()
   ...
   ## take averages for repeated crypts? or just take prediction for largest bbox?   
