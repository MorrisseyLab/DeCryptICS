...
def SegmentSTAG(img, thresh_cut):
    ...
    if thresh_cut is None:
        thresh_cut_nucl, thresh_cut_nucl_blur, th_clone = calculate_thresholds(img, deconv_mat_STAG)
    else:
        thresh_cut_nucl, thresh_cut_nucl_blur, th_clone = thresh_cut #thresh_stringent, thresh_lax 

    ## Colour deconvolution
    smallBlur_img_nuc, blurred_img_nuc, blurred_img_clone = col_deconvol_and_blur(img, deconv_mat_STAG, (11, 11), (37, 37), (27, 27))
