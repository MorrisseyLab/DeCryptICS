...
from mPAS_Segment_Clone       import get_mPAS_Stains2 ##!!!!!!!!!!!!!!!!!!!!!!!
from makeCloneImage           import makeImageClones
from func_mPAS_crypt_clone    import getCloneFeatures, getCryptFeatures
...
def SegmentNONO(img, thresh_cut):
    ...
    if thresh_cut is None:
        thresh_cut_nucl, thresh_cut_nucl_blur, th_clone = calculate_thresholds(img, deconv_mat_NONO)
    else:
        thresh_cut_nucl, thresh_cut_nucl_blur, th_clone = thresh_cut #thresh_stringent, thresh_lax 

    ## Colour deconvolution
    smallBlur_img_nuc, blurred_img_nuc, blurred_img_clone = col_deconvol_and_blur(img, deconv_mat_NONO, (11, 11), (37, 37), (27, 27))
