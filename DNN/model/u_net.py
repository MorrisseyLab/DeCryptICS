...
from DNN.model.losses       import bce_dice_loss, dice_loss, weighted_bce_dice_loss, weighted_dice_loss, dice_coeff
...
def get_unet_4096(input_shape=(4096, 4096, 3),
    ...
    down0d = Conv2D(2, (3, 3), padding='same')(inputs)
    down0d = BatchNormalization()(down0d)
    down0d = Activation('relu')(down0d)
    down0d = Conv2D(2, (3, 3), padding='same')(down0d)
    down0d = BatchNormalization()(down0d)
    down0d = Activation('relu')(down0d)
